...
Feature: Scoreboard --> Players page
  ...
  Scenario: Scenario_03: verify the player page headers.
    Given User log in to "scoreboard" for "admin" UI and present at the home page.
    Then user click on "players module" button.
  ...
  Scenario: Scenario_04: delete player and verify the deleted player.
    Given User log in to "scoreboard" for "admin" UI and present at the home page.
    Then user click on "players module" button.
    Then user search already added player.
  ...
  @Scoreboard_SCOR35
  Scenario: Scenario_05: Add player and verify the added player.
    Given User log in to "scoreboard" for "admin" UI and present at the home page.
    Then user click on "players module" button.
...
#    Then user search already added player.
  ...
  @Scoreboard_SCOR80
  Scenario: Scenario_07: edit player and verify the edited player.
    Given User log in to "scoreboard" for "admin" UI and present at the home page.
    Then user click on "teams module" button.
    Then user verify the teams based on the gender.

  @Scoreboard_SCOR90
  Scenario: Scenario_08: verify inactive team in create player popup
    Given User log in to "scoreboard" for "admin" UI and present at the home page.
    Then user click on "teams module" button.
    Then user will "add" the "Teams" with count of "1" with following details and verify
      | Gender |
      | Men    |
    Then user make "1" team as "non live" and verify it.
    Then user click on "players module" button.
    Then user verify inactive team on create player popup.

  @Scoreboard_SCOR114
  Scenario: Scenario_09: verify country name and count on player creation popup.
    Given User log in to "scoreboard" for "admin" UI and present at the home page.
    Then user click on "players module" button.
