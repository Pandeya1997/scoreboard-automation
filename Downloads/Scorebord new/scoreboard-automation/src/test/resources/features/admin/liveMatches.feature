...
Feature: Scoreboard --> live match page
  ...
  @Scoreboard_SCOR468
  Scenario: Scenario_02: Add validation to prevent removal of Agent/Manager during a live match
    Given User log in to "scoreboard" for "admin" UI and present at the home page.
...
#    Then user will logout the current user.
  ...
  @Scoreboard_SCOR416
  Scenario: Scenario_03: Clear button not clickable on the Live Match filter when filtering by venue.
