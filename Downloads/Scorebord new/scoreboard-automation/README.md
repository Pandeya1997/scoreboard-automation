...
```
cd existing_repo
git remote add origin https://allproject.live/scorecard1/scoreboard-automation.git
git branch -M main
...
- [ ] [Set up project integrations](https://allproject.live/scorecard1/scoreboard-automation/-/settings/integrations)
